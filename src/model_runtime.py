...
def load_models() -> tuple[object, object]:
    """Nacte ulozene modely pro viteze a Under/Over."""
...
def add_model_predictions(
    ...
    models: tuple[object, object] | None = None,
) -> pd.DataFrame:
    """Prida do dataframe predikce viteze a Under/Over label."""
    if dataframe.empty:
        return dataframe.copy()

    prepared = ensure_feature_columns(dataframe)
    winner_model, goal_line_payload = models or load_models()
